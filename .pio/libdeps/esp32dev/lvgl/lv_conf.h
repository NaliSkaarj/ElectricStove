...
#define LV_FONT_CUSTOM_DECLARE \
        LV_FONT_DECLARE(lv_font_montserrat_custom_16) \
        LV_FONT_DECLARE(lv_font_montserrat_custom_24) \
        LV_FONT_DECLARE(lv_font_montserrat_custom_32) \
        LV_FONT_DECLARE(lv_font_montserrat_custom_38)

/*Always set a default font*/
#define LV_FONT_DEFAULT &lv_font_montserrat_custom_16
