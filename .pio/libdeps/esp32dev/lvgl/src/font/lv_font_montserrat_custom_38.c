 ...
 * Size: 38 px
 * Bpp: 4
 * Opts: --bpp 4 --size 38 --no-compress --font Montserrat-Medium.ttf --symbols ąćęłńóśżźĄĆĘŁŃÓŚŻŹ --range 32-126,176 --font FontAwesome5-Solid+Brands+Regular.woff --range 61480,61931,61461,61451,61459,61524 --format lvgl -o lv_font_montserrat_custom_38.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 29249, .adv_w = 608, .box_w = 36, .box_h = 39, .ofs_x = 1, .ofs_y = -5},
    {.bitmap_index = 29951, .adv_w = 684, .box_w = 43, .box_h = 34, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 30682, .adv_w = 684, .box_w = 43, .box_h = 37, .ofs_x = 0, .ofs_y = -4},
    {.bitmap_index = 31478, .adv_w = 380, .box_w = 20, .box_h = 33, .ofs_x = 2, .ofs_y = -2},
    {.bitmap_index = 31808, .adv_w = 760, .box_w = 48, .box_h = 35, .ofs_x = 0, .ofs_y = -3}
};
...
static const uint16_t unicode_list_1[] = {
    ...
    0xca, 0xcb, 0xcc, 0xef5b, 0xef63, 0xef65, 0xef78, 0xefa4,
    0xf13b
};
