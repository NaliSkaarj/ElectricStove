 ...
 * Size: 24 px
 * Bpp: 4
 * Opts: --bpp 4 --size 24 --no-compress --font Montserrat-Medium.ttf --symbols ąćęłńóśżźĄĆĘŁŃÓŚŻŹ --range 32-126,176 --font FontAwesome5-Solid+Brands+Regular.woff --range 61451,61452,61453,61459,61461,61480,61524,61931 --format lvgl -o lv_font_montserrat_custom_24.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 10143, .adv_w = 274, .box_w = 16, .box_h = 22, .ofs_x = 1, .ofs_y = 0},
    ...
    {.bitmap_index = 12011, .adv_w = 384, .box_w = 24, .box_h = 22, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 12275, .adv_w = 384, .box_w = 24, .box_h = 18, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 12491, .adv_w = 264, .box_w = 17, .box_h = 18, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 12644, .adv_w = 384, .box_w = 24, .box_h = 24, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 12932, .adv_w = 432, .box_w = 27, .box_h = 22, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 13229, .adv_w = 432, .box_w = 27, .box_h = 24, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 13553, .adv_w = 240, .box_w = 13, .box_h = 22, .ofs_x = 1, .ofs_y = -2},
    {.bitmap_index = 13696, .adv_w = 480, .box_w = 30, .box_h = 23, .ofs_x = 0, .ofs_y = -2}
};
