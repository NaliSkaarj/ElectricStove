 ...
 * Size: 32 px
 * Bpp: 4
 * Opts: --bpp 4 --size 32 --no-compress --font Montserrat-Medium.ttf --symbols ąćęłńóśżźĄĆĘŁŃÓŚŻŹ --range 32-126,176 --font FontAwesome5-Solid+Brands+Regular.woff --range 61480,61931,61461,61451,61459,61524 --format lvgl -o lv_font_montserrat_custom_32.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 20903, .adv_w = 512, .box_w = 30, .box_h = 32, .ofs_x = 1, .ofs_y = -4},
    {.bitmap_index = 21383, .adv_w = 576, .box_w = 36, .box_h = 28, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 21887, .adv_w = 576, .box_w = 36, .box_h = 32, .ofs_x = 0, .ofs_y = -4},
    {.bitmap_index = 22463, .adv_w = 320, .box_w = 18, .box_h = 28, .ofs_x = 1, .ofs_y = -2},
    {.bitmap_index = 22715, .adv_w = 640, .box_w = 40, .box_h = 29, .ofs_x = 0, .ofs_y = -2}
};
